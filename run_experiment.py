...
def _lcp_frac(a: list[int], b: list[int]) -> float:
...
def stage3_metrics(results: list[dict], tokenizer) -> list[dict]:
    ...
    for r in results:
        ...
        r["lcp_frac_regen"] = _lcp_frac(r1_t, regen_t)
        r["lcp_frac_edit"] = _lcp_frac(r1_t, edit_t)
    return results
...
def summarize(results: list[dict], stage1_count: int) -> dict:
    ...
    summary = {
        ...
        "lcp_frac_regen": avg("lcp_frac_regen"),
        "lcp_frac_edit": avg("lcp_frac_edit"),
    }
    print("\n=== Summary ===")
